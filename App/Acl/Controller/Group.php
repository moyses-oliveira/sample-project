...
class Group extends AbstractController {
    ...
    public function datatable()
    {
        ...
        $repository = $this->getEm()->getRepository(\Data\Entity\Acl\Group::class);
    ...
    public function update($pk)
    {
        ...
        $entity = (new \Data\Entity\Acl\Group)->load($pk);
        if(!$entity)
    ...
    {
        $entity = new \Data\Entity\Acl\Group();
        if(!!$pk && !$entity->load($pk))
            return $this->json403();

        $response = (new \Data\Service\Acl\Group())->save($entity, $_POST);

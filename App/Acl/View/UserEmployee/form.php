...
$form->set(new Select('fkAuthority', $authorityOptions, 'Responde à: ', 'Ninguém'));

$form->set(new Checkbox('tnyCommercial', '1', 'Autorizado para uso somente em horario comercial', $tnyCommercial));
$form->get('tnyCommercial')->getBox()->addClass('col-xs-12 h4');
